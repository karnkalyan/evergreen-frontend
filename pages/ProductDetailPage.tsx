...
const ProductDetailPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{seoData?.metaTitle || product?.name || 'Product Details'}</title>
        <meta name="description" content={seoData?.metaDescription || product?.description?.replace(/<[^>]*>/g, '').substring(0, 160) || 'Buy quality medicines and health products online.'} />
